...
(function(global, factory) {
    ...
    // console.log('isBuiltInTag', isBuiltInTag('slot20'));
    /**
    ...
    // arrayMethods  调用数组methodsToPatch 中的方法触发 监听数据更新
    ...
    var arrayKeys = Object.getOwnPropertyNames(arrayMethods); // ["push", "pop", "shift", "unshift", "splice", "sort", "reverse"]
